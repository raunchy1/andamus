...
const EMAIL_STRINGS: Record<EmailLocale, Record<string, string>> = {
  it: {
    ...
    rideReminderBody: "ti ricordiamo che <strong style=\"color: #2D6A4F;\">domani</strong> hai un passaggio in programma",
  ...
  en: {
    ...
    rideReminderBody:
      "we remind you that <strong style=\"color: #2D6A4F;\">tomorrow</strong> you have a ride scheduled",
    rideReminderDriverTip:
  ...
  de: {
    ...
    rideReminderBody:
      "wir erinnern dich daran, dass du <strong style=\"color: #2D6A4F;\">morgen</strong> eine Fahrt geplant hast",
    rideReminderDriverTip:
