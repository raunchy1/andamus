      ...
      >
        ...
        <div
          style={{
            ...
            height: 500,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(210,103,58,0.08) 0%, transparent 70%)",
          }}
        />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          >
            ...
            <span style={{ fontSize: 48, color: "#2D6A4F", fontWeight: 300 }}>→</span>
            <span style={{ fontSize: 64, fontWeight: 800, color: "white", letterSpacing: "-0.03em" }}>
              {toCity}
            </span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            ...
            <span
              style={{
                fontSize: 28,
                fontWeight: 700,
                color: price > 0 ? "#2D6A4F" : "#10b981",
                background: price > 0 ? "rgba(45,106,79,0.15)" : "rgba(16,185,129,0.15)",
                padding: "8px 20px",
                borderRadius: 12,
              }}
            >
