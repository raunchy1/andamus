    ...
    <div className={`flex flex-col items-center justify-center py-12 text-center gap-4 ${className}`}>
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-accent-fg rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity active:scale-95"
        >
