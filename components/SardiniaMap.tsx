...
const cities = [
  { name: "Cagliari",  svgX: 131.5, svgY: 526.5, population: "154k", isCapital: true },
  { name: "Sassari",   svgX: 103.5, svgY: 425.0, population: "127k", isCapital: false },
  { name: "Olbia",     svgX: 140.0, svgY: 418.0, population: "60k",  isCapital: false },
  { name: "Nuoro",     svgX: 142.5, svgY: 452.0, population: "37k",  isCapital: false },
  { name: "Oristano",  svgX: 105.5, svgY: 479.5, population: "32k",  isCapital: false },
  { name: "Tortoli",   svgX: 159.0, svgY: 478.0, population: "11k",  isCapital: false },
  { name: "Alghero",   svgX: 91.5,  svgY: 436.5, population: "44k",  isCapital: false },
  { name: "Carbonia",  svgX: 103.0, svgY: 530.5, population: "28k",  isCapital: false },
];

const routes = [
  { from: "Cagliari", to: "Oristano" },
  { from: "Cagliari", to: "Carbonia" },
  { from: "Sassari",  to: "Alghero" },
  { from: "Sassari",  to: "Olbia" },
  { from: "Olbia",    to: "Nuoro" },
  { from: "Nuoro",    to: "Tortoli" },
  { from: "Oristano", to: "Sassari" },
