...
const cities = [
  { name: "Cagliari",  svgX: 131.8, svgY: 525.8, population: "154k", isCapital: true },
  { name: "Sassari",   svgX: 103.8, svgY: 425.6, population: "127k", isCapital: false },
  { name: "Olbia",     svgX: 139.5, svgY: 418.8, population: "60k",  isCapital: false },
  { name: "Nuoro",     svgX: 142.0, svgY: 453.4, population: "37k",  isCapital: false },
  { name: "Oristano",  svgX: 105.8, svgY: 480.2, population: "32k",  isCapital: false },
  { name: "Tortolì",   svgX: 158.5, svgY: 478.5, population: "11k",  isCapital: false },
  { name: "Alghero",   svgX: 92.0,  svgY: 437.0, population: "44k",  isCapital: false },
  { name: "Carbonia",  svgX: 103.5, svgY: 529.8, population: "28k",  isCapital: false },
];
...
const routes: RouteData[] = [
  ...
  { from: "Olbia", to: "Nuoro", waypoints: [{ x: 145, y: 435 }] },
  { from: "Nuoro", to: "Tortolì", waypoints: [{ x: 152, y: 463 }] },
  { from: "Nuoro", to: "Sassari", waypoints: [{ x: 120, y: 438 }] },
  { from: "Oristano", to: "Sassari", waypoints: [{ x: 103, y: 458 }] },
  { from: "Cagliari", to: "Oristano", waypoints: [{ x: 115, y: 502 }] },
  { from: "Cagliari", to: "Nuoro", waypoints: [{ x: 132, y: 500 }, { x: 138, y: 475 }] },
];
