  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <Car className="h-7 w-7 text-[#e63946]" />
          <span className="text-xl font-bold tracking-tight">Andamus</span>
        </Link>
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <span className={`text-sm font-medium ${isHome ? "text-white" : "text-[#1a1a2e]"}`}>
                      {getUserName()}
                    </span>
                  </Link>
                  <button
                    ...
                    className={`flex h-9 w-9 items-center justify-center rounded-full transition-colors ${
                      isHome 
                        ...
                        : "text-muted-foreground hover:bg-muted hover:text-[#1a1a2e]"
                    }`}
                    title="Esci"
                  >
                ...
                <Button
                  onClick={handleLogin}
                  className="bg-[#e63946] text-white hover:bg-[#c92a37]"
                >
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className={`border-t md:hidden ${isHome ? "border-white/10 bg-[#1a1a2e]" : "border-border bg-background"}`}>
