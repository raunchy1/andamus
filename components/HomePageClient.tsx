      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <section className="relative px-4 sm:px-6 pt-6">
          <h2 className="font-headline font-extrabold tracking-tighter text-[2.25rem] sm:text-[2.75rem] leading-[0.95] mb-6 sm:mb-8 word-break">
            {t.heroTitle} {t.heroTitleHighlight} {t.heroSubtitle}
          </h2>
        ...
        <section className="mb-8 sm:mb-12">
          <div className="px-4 sm:px-6 flex justify-between items-end mb-4 sm:mb-6">
            <h3 className="text-sm font-bold uppercase tracking-[0.1em] text-on-surface truncate pr-2">{t.todayRides}</h3>
          ...
          {loading ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[10px] text-on-surface/60">{ride.profiles.rating}{t.car}</span>
                      </div>
                    </div>
                  </div>
                </Link>
            ...
            <div className="px-4 sm:px-6">
              <div className="bg-surface-container-high p-4 sm:p-5 rounded-xl">
                ...
                <Link href="/cerca" className="text-primary text-sm font-bold mt-2 inline-block">{t.searchOtherDates} →</Link>
              </div>
            </div>
          )}
        </section>
    ...
    <div className="min-h-screen bg-[#0f0f0f] text-[#e5e2e1]">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 max-w-3xl">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter leading-[0.95] mb-8">
                {t.heroTitle} <span className="text-[#ffb3b1]">{t.heroTitleHighlight}</span> {t.heroSubtitle}
              </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-20">
        <div className="flex items-end justify-between mb-10">
          <div>
            <h3 className="text-3xl font-extrabold tracking-tight">{t.todayRides}</h3>
            <p className="text-[#e5e2e1]/50 mt-2">{t.departuresConfirmed} {new Date().toLocaleDateString(locale, { day: "numeric", month: "long" })}</p>
          </div>
        ...
        {loading ? (
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-white/5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs text-[#e5e2e1]/60">{ride.profiles.rating}{t.car}</span>
                    </div>
                  </div>
                </div>
              </Link>
          ...
          <div className="rounded-2xl bg-white/[0.02] border border-white/5 p-10 text-center">
            <p className="text-[#e5e2e1]/60">{t.noRidesToday}</p>
            <Link href="/cerca" className="inline-block mt-4 text-[#ffb3b1] font-bold hover:underline">{t.searchOtherDates}</Link>
          </div>
        )}
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="flex flex-col gap-5 p-6 lg:p-8 rounded-2xl bg-white/[0.02] border border-white/5 min-h-[280px]">
              ...
              <div className="flex flex-col gap-3">
                <h4 className="text-xl font-bold">{t.feature1Title}</h4>
                <p className="text-[#e5e2e1]/50 leading-relaxed text-base">{t.feature1Description}</p>
              </div>
            </div>
            {/* Card 2 */}
            <div className="flex flex-col gap-5 p-6 lg:p-8 rounded-2xl bg-white/[0.02] border border-white/5 min-h-[280px]">
              ...
              <div className="flex flex-col gap-3">
                <h4 className="text-xl font-bold">{t.feature2Title}</h4>
                <p className="text-[#e5e2e1]/50 leading-relaxed text-base">{t.feature2Description}</p>
              </div>
            </div>
            {/* Card 3 */}
            <div className="flex flex-col gap-5 p-6 lg:p-8 rounded-2xl bg-white/[0.02] border border-white/5 min-h-[280px]">
              ...
              <div className="flex flex-col gap-3">
                <h4 className="text-xl font-bold">{t.feature3Title}</h4>
                <p className="text-[#e5e2e1]/50 leading-relaxed text-base">{t.feature3Description}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-20 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h3 className="text-2xl font-extrabold tracking-tight mb-2">{t.ctaTitle}</h3>
            <p className="text-[#e5e2e1]/50">{t.ctaDescription}</p>
          </div>
          <Link
            href="/offri"
